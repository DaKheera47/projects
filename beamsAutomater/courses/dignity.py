...
# quiz
time.sleep(DELAY)
# link = "https://prism.beaconhouse.net/mod/quiz/attempt.php?attempt=242067&cmid=4265"
link = "https://prism.beaconhouse.net/course/view.php?id=139"
driver.get(link)
quizNum = 1
...
# q1
# chosenAnswer = ["b", ["a", "c"], "d", "a"]
# q2
# chosenAnswer = ["b", "b", "c", "c", "c"]
# q3
chosenAnswer = ["d", "c", "d"]
